...
class BookingControllerIntegrationTest {
    ...
    @Test
    void createNewBooking_WhenNotValidBookingDtoItemId_ReturnBadRequiredException() throws Exception {
        ...
        verify((bookingService), never()).create(bookingDto, 1L);
    }

    @Test
    void createNewBooking_WhenNotValidBookingDtoStartNull_ReturnBadRequiredException() throws Exception {
    ...
    @Test
    void createNewBooking_WhenNotValidBookingDtoStartInPast_ReturnBadRequiredException() throws Exception {
    ...
    @Test
    void createNewBooking_WhenNotValidBookingDtoEndNull_ReturnBadRequiredException() throws Exception {
    ...
    @Test
    void createNewBooking_WhenNotValidBookingDtoEndInPast_ReturnBadRequiredException() throws Exception {
        bookingDto.setEnd(time.minusDays(1));
    ...
    @Test
    void createNewBooking_WhenNotValidBookingDtoEndEqualsStart_ReturnBadRequiredException() throws Exception {
